...
- [x] Migrar banco de dados de MySQL (Azure) para PostgreSQL (Supabase)
- [x] Refatorar backend para Express + tRPC compatível com Vercel Serverless
...
- [x] Implementar sistema de recarga via Pix com notificação manual
